...
def get_parser():
    ...
    parser.add_argument('--summary_path', default='./output/summary/finetune', help='the summary file save path')
    parser.add_argument('--ckpt_path', default='./output/ckpt/finetune', help='the ckpt file save path')
    ...
    parser.add_argument('--num_gpus', default=2,type=int, help='the num of gpus')
